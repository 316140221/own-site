const I18N = {
  en: {
    ...
    "home.start": "Start",
    "home.latest": "Latest",
    "home.latestMore": "View all latest",
    ...
    "runs.title": "Runs",
    "runs.caption": "Run history",
    "runs.recent": "Recent {count} runs.",
    "runs.table.finished": "Finished",
    "runs.table.sources": "Sources",
    "runs.table.items": "Items",
    "runs.table.trend": "Trend",
    "runs.table.cleanup": "Cleanup",
    "runs.table.articles": "Articles",
    "runs.sourcesCell": "{ok} OK / {failed} failed / {paused} paused",
    ...
    "sources.table.category": "Category",
    "sources.table.status": "Status",
    "sources.table.lastFetch": "Last fetch",
    "sources.table.lastSuccess": "Last success",
    "sources.table.paused": "Paused",
    "sources.table.added": "Added",
    "sources.table.dup": "Dup",
    "sources.table.failStreak": "Fail streak",
    ...
    "tools.item.discount.title": "Discount Calculator",
    "tools.item.discount.desc":
      "Calculate discount amount, final price, and totals (with optional sales tax).",
    ...
    "tools.item.home-affordability.title": "Home Affordability Calculator",
    "tools.item.home-affordability.desc":
      "Estimate how much house you can afford using income, debts, and loan assumptions.",
    "tools.item.loan.title": "Loan Calculator",
    "tools.item.loan.desc": "Calculate loan payments, totals, and payoff with extra payments.",
    "tools.item.budget-50-30-20.title": "50/30/20 Budget Calculator",
    "tools.item.budget-50-30-20.desc":
      "Split your monthly income into needs, wants, and savings using the 50/30/20 rule.",
    "tools.item.apr-apy.title": "APR ↔ APY Converter",
    "tools.item.apr-apy.desc":
      "Convert between APR and APY with compounding frequency (daily/monthly/quarterly/annual).",
    ...
    "tools.item.take-home-pay.title": "Take-Home Pay Calculator",
    "tools.item.take-home-pay.desc":
      "Estimate paycheck take-home pay using custom tax rates and deductions.",
    "tools.item.auto-loan.title": "Auto Loan Calculator",
    "tools.item.auto-loan.desc":
      "Estimate car payment (price, trade-in, down payment, taxes, fees).",
    "tools.item.net-worth.title": "Net Worth Calculator",
    "tools.item.net-worth.desc": "Calculate net worth from assets and liabilities.",
    "tools.item.credit-utilization.title": "Credit Utilization Calculator",
    "tools.item.credit-utilization.desc":
      "Calculate credit utilization per card and overall (balance ÷ limit).",
    "tools.item.emergency-fund.title": "Emergency Fund Calculator",
    "tools.item.emergency-fund.desc":
      "Estimate emergency fund target and time to reach it.",
    "tools.item.inflation.title": "Inflation Calculator",
    "tools.item.inflation.desc":
      "Estimate future value or today’s value using an inflation rate.",
    "tools.item.four-percent-rule.title": "4% Rule Calculator",
    "tools.item.four-percent-rule.desc":
      "Estimate retirement savings needed using a withdrawal rate (e.g., 4%).",
    "tools.item.fire.title": "FIRE Number Calculator",
    "tools.item.fire.desc":
      "Calculate your FIRE number and estimate years to financial independence.",
    ...
    "tools.item.rent-affordability.title": "Rent Affordability Calculator",
    "tools.item.rent-affordability.desc":
      "Estimate max affordable rent (or required income) using the rent-to-income rule.",
    "tools.item.rent-vs-buy.title": "Rent vs Buy Calculator",
    "tools.item.rent-vs-buy.desc":
      "Compare renting vs buying over time and estimate break-even.",
    "tools.item.debt-to-income.title": "Debt-to-Income (DTI) Calculator",
    "tools.item.debt-to-income.desc":
      "Calculate your debt-to-income ratio (DTI) from monthly income and debts.",
    ...
    "tools.item.debt-payoff-plan.title": "Debt Payoff Planner",
    "tools.item.debt-payoff-plan.desc":
      "Plan debt payoff with snowball or avalanche strategy across multiple debts.",
    ...
    "tools.item.investment-fees.title": "Investment Fees Calculator",
    "tools.item.investment-fees.desc":
      "Estimate how investment fees (expense ratio) affect long-term growth.",
    "tools.item.savings-goal.title": "Savings Goal Calculator",
    "tools.item.savings-goal.desc":
      "Estimate time to reach a savings goal or required monthly savings.",
    "tools.item.retirement.title": "401(k) & Retirement Calculator",
    "tools.item.retirement.desc":
      "Estimate retirement savings growth with contributions and employer match.",
    "tools.item.cagr.title": "CAGR Calculator",
    "tools.item.cagr.desc": "Calculate compound annual growth rate (CAGR) and total return.",
    ...
    "tools.item.zodiac-compatibility.title": "Zodiac Compatibility",
    "tools.item.zodiac-compatibility.desc":
      "Fun compatibility score and tips by zodiac sign (entertainment only).",
    ...
    "tool.discount.price": "Price",
    "tool.discount.pricePlaceholder": "e.g. 49.99",
    "tool.discount.discountPercent": "Discount %",
    "tool.discount.taxRate": "Sales tax % (optional)",
    "tool.discount.qty": "Qty",
    "tool.discount.presets": "Presets:",
    "tool.discount.calculate": "Calculate",
    "tool.discount.status.done": "Calculated",
    "tool.discount.error.price": "Please enter a valid price",
    "tool.discount.error.discountPercent": "Please enter a valid discount percent",
    "tool.discount.error.taxRate": "Please enter a valid tax rate",
    "tool.discount.out.price": "Price",
    "tool.discount.out.discountPercent": "Discount",
    "tool.discount.out.taxRate": "Sales tax",
    "tool.discount.out.qty": "Qty",
    "tool.discount.out.subtotal": "Subtotal",
    "tool.discount.out.discountAmount": "Discount amount",
    "tool.discount.out.afterDiscount": "After discount",
    "tool.discount.out.tax": "Tax",
    "tool.discount.out.total": "Total",
    "tool.discount.out.perItem": "Per item",
    ...
    "tool.zodiacCompat.disclaimer": "For entertainment only. Not advice.",
    "tool.zodiacCompat.you": "Your sign",
    "tool.zodiacCompat.them": "Their sign",
    "tool.zodiacCompat.type": "Type",
    "tool.zodiacCompat.type.love": "Love",
    "tool.zodiacCompat.type.friendship": "Friendship",
    "tool.zodiacCompat.type.work": "Work",
    "tool.zodiacCompat.generate": "Generate",
    "tool.zodiacCompat.status.done": "Generated",
    "tool.zodiacCompat.out.you": "You",
    "tool.zodiacCompat.out.them": "Them",
    "tool.zodiacCompat.out.type": "Type",
    "tool.zodiacCompat.out.elements": "Elements",
    "tool.zodiacCompat.out.score": "Score",
    "tool.zodiacCompat.out.strengths": "Strengths",
    "tool.zodiacCompat.out.challenges": "Challenges",
    "tool.zodiacCompat.out.tip": "Tip",
    ...
    "tool.homeAfford.disclaimer": "Estimates only. Not financial advice.",
    "tool.homeAfford.income": "Gross monthly income",
    "tool.homeAfford.incomePlaceholder": "e.g. 8000",
    "tool.homeAfford.debts": "Other monthly debts",
    "tool.homeAfford.debtsPlaceholder": "e.g. 400",
    "tool.homeAfford.housingPct": "Housing % of income",
    "tool.homeAfford.dtiPct": "Max DTI %",
    "tool.homeAfford.downMode": "Down payment",
    "tool.homeAfford.downMode.percent": "Percent",
    "tool.homeAfford.downMode.amount": "Amount",
    "tool.homeAfford.down": "Down payment value",
    "tool.homeAfford.downPlaceholder": "e.g. 20",
    "tool.homeAfford.apr": "APR %",
    "tool.homeAfford.termYears": "Term",
    "tool.homeAfford.years": "years",
    "tool.homeAfford.tax": "Property tax / year",
    "tool.homeAfford.taxPlaceholder": "e.g. 6000",
    "tool.homeAfford.insurance": "Insurance / year",
    "tool.homeAfford.insurancePlaceholder": "e.g. 1200",
    "tool.homeAfford.hoa": "HOA / month",
    "tool.homeAfford.hoaPlaceholder": "e.g. 0",
    "tool.homeAfford.pmi": "PMI / month (optional)",
    "tool.homeAfford.pmiPlaceholder": "e.g. 0",
    "tool.homeAfford.calculate": "Calculate",
    "tool.homeAfford.status.done": "Calculated",
    "tool.homeAfford.error.income": "Please enter a valid gross monthly income",
    "tool.homeAfford.error.debts": "Please enter a valid debt amount",
    "tool.homeAfford.error.allowed": "Allowed housing payment is ≤ 0. Please check your inputs.",
    "tool.homeAfford.error.extras": "Extras are too high (tax/insurance/HOA/PMI).",
    "tool.homeAfford.error.down": "Please enter a valid down payment",
    "tool.homeAfford.error.generic": "Calculation failed. Please check your inputs.",
    "tool.homeAfford.out.income": "Monthly income",
    "tool.homeAfford.out.debts": "Other debts",
    "tool.homeAfford.out.housingLimit": "Housing limit",
    "tool.homeAfford.out.dtiLimit": "DTI limit",
    "tool.homeAfford.out.allowed": "Allowed housing payment",
    "tool.homeAfford.out.extras": "Extras (monthly)",
    "tool.homeAfford.out.maxPI": "Max P&I",
    "tool.homeAfford.out.loanAmount": "Max loan amount",
    "tool.homeAfford.out.downPayment": "Down payment",
    "tool.homeAfford.out.homePrice": "Max home price",
    "tool.homeAfford.out.apr": "APR",
    "tool.homeAfford.out.term": "Term",
    "tool.homeAfford.out.pi": "P&I",
    "tool.homeAfford.out.monthlyTotal": "Monthly total",
    ...
    "tool.budget503020.income": "Monthly income",
    "tool.budget503020.incomePlaceholder": "e.g. 4500",
    "tool.budget503020.needsPct": "Needs %",
    "tool.budget503020.wantsPct": "Wants %",
    "tool.budget503020.savingsPct": "Savings/Debt %",
    "tool.budget503020.reset": "Reset 50/30/20",
    "tool.budget503020.calculate": "Calculate",
    "tool.budget503020.status.done": "Calculated",
    "tool.budget503020.error.income": "Please enter a valid monthly income",
    "tool.budget503020.error.percentSum": "Percentages must add up to 100% (current: {sum})",
    "tool.budget503020.out.income": "Monthly income",
    "tool.budget503020.out.rule": "Rule (needs / wants / savings)",
    "tool.budget503020.out.needs": "Needs",
    "tool.budget503020.out.wants": "Wants",
    "tool.budget503020.out.savings": "Savings/Debt",
    "tool.budget503020.out.monthly": "monthly",
    "tool.budget503020.out.weekly": "weekly",
    "tool.budget503020.out.daily": "daily",

    "tool.aprApy.rate": "Rate %",
    "tool.aprApy.ratePlaceholder": "e.g. 5.00",
    "tool.aprApy.mode": "Mode",
    "tool.aprApy.mode.aprToApy": "APR → APY",
    "tool.aprApy.mode.apyToApr": "APY → APR",
    "tool.aprApy.compounding": "Compounding",
    "tool.aprApy.compound.daily": "Daily (365)",
    "tool.aprApy.compound.monthly": "Monthly (12)",
    "tool.aprApy.compound.quarterly": "Quarterly (4)",
    "tool.aprApy.compound.annual": "Annual (1)",
    "tool.aprApy.compound.continuous": "Continuous",
    "tool.aprApy.calculate": "Calculate",
    "tool.aprApy.status.done": "Calculated",
    "tool.aprApy.error.rate": "Please enter a valid rate",
    "tool.aprApy.error.generic": "Calculation failed. Please check your inputs.",
    "tool.aprApy.out.mode": "Mode",
    "tool.aprApy.out.compounding": "Compounding",
    "tool.aprApy.out.input": "Input",
    "tool.aprApy.out.output": "Output",
    ...
    "tool.takeHomePay.disclaimer": "Estimates only. Not tax advice.",
    "tool.takeHomePay.gross": "Gross pay",
    "tool.takeHomePay.grossPlaceholder": "e.g. 2500",
    "tool.takeHomePay.frequency": "Pay frequency",
    "tool.takeHomePay.frequency.weekly": "Weekly (52)",
    "tool.takeHomePay.frequency.biweekly": "Biweekly (26)",
    "tool.takeHomePay.frequency.semimonthly": "Semi-monthly (24)",
    "tool.takeHomePay.frequency.monthly": "Monthly (12)",
    "tool.takeHomePay.pretax": "Pre-tax deductions (per pay period)",
    "tool.takeHomePay.pretaxPlaceholder": "e.g. 150",
    "tool.takeHomePay.federal": "Federal tax %",
    "tool.takeHomePay.state": "State tax %",
    "tool.takeHomePay.local": "Local tax %",
    "tool.takeHomePay.fica": "FICA %",
    "tool.takeHomePay.posttax": "Post-tax deductions (per pay period)",
    "tool.takeHomePay.posttaxPlaceholder": "e.g. 0",
    "tool.takeHomePay.showAnnual": "Show annual totals",
    "tool.takeHomePay.calculate": "Calculate",
    "tool.takeHomePay.status.done": "Calculated",
    "tool.takeHomePay.error.gross": "Please enter a valid gross pay amount",
    "tool.takeHomePay.error.pretax": "Please enter a valid pre-tax deduction",
    "tool.takeHomePay.error.posttax": "Please enter a valid post-tax deduction",
    "tool.takeHomePay.error.net": "Net pay is negative. Please check deductions and tax rates.",
    "tool.takeHomePay.out.gross": "Gross pay",
    "tool.takeHomePay.out.frequency": "Frequency",
    "tool.takeHomePay.out.pretax": "Pre-tax deductions",
    "tool.takeHomePay.out.taxable": "Taxable pay",
    "tool.takeHomePay.out.federal": "Federal",
    "tool.takeHomePay.out.state": "State",
    "tool.takeHomePay.out.local": "Local",
    "tool.takeHomePay.out.fica": "FICA",
    "tool.takeHomePay.out.taxesTotal": "Total taxes",
    "tool.takeHomePay.out.posttax": "Post-tax deductions",
    "tool.takeHomePay.out.net": "Take-home pay",
    "tool.takeHomePay.out.takeHomeRate": "Take-home rate",
    "tool.takeHomePay.out.annualGross": "Annual gross",
    "tool.takeHomePay.out.annualPretax": "Annual pre-tax",
    "tool.takeHomePay.out.annualTaxable": "Annual taxable",
    "tool.takeHomePay.out.annualTaxes": "Annual taxes",
    "tool.takeHomePay.out.annualPosttax": "Annual post-tax",
    "tool.takeHomePay.out.annualNet": "Annual take-home",

    "tool.autoLoan.disclaimer": "Estimates only. Not financial advice.",
    "tool.autoLoan.price": "Vehicle price",
    "tool.autoLoan.pricePlaceholder": "e.g. 30000",
    "tool.autoLoan.tradeIn": "Trade-in value",
    "tool.autoLoan.tradeInPlaceholder": "e.g. 5000",
    "tool.autoLoan.down": "Down payment",
    "tool.autoLoan.downPlaceholder": "e.g. 3000",
    "tool.autoLoan.taxRate": "Sales tax %",
    "tool.autoLoan.taxAfterTradeIn": "Apply tax after trade-in",
    "tool.autoLoan.fees": "Fees (title/doc/registration)",
    "tool.autoLoan.feesPlaceholder": "e.g. 500",
    "tool.autoLoan.apr": "APR %",
    "tool.autoLoan.termMonths": "Term",
    "tool.autoLoan.termPresets": "Presets:",
    "tool.autoLoan.months": "months",
    "tool.autoLoan.years": "years",
    "tool.autoLoan.extra": "Extra payment / month",
    "tool.autoLoan.extraPlaceholder": "e.g. 50",
    "tool.autoLoan.showSchedule": "Show first 12 payments",
    "tool.autoLoan.calculate": "Calculate",
    "tool.autoLoan.status.done": "Calculated",
    "tool.autoLoan.error.price": "Please enter a valid vehicle price",
    "tool.autoLoan.error.tradeIn": "Please enter a valid trade-in value",
    "tool.autoLoan.error.down": "Please enter a valid down payment",
    "tool.autoLoan.error.fees": "Please enter a valid fees amount",
    "tool.autoLoan.error.extra": "Please enter a valid extra payment",
    "tool.autoLoan.error.generic": "Calculation failed. Please check your inputs.",
    "tool.autoLoan.out.price": "Vehicle price",
    "tool.autoLoan.out.tradeIn": "Trade-in",
    "tool.autoLoan.out.down": "Down payment",
    "tool.autoLoan.out.fees": "Fees",
    "tool.autoLoan.out.taxRate": "Tax rate",
    "tool.autoLoan.out.taxableAmount": "Taxable amount",
    "tool.autoLoan.out.tax": "Tax",
    "tool.autoLoan.out.amountFinanced": "Amount financed",
    "tool.autoLoan.out.apr": "APR",
    "tool.autoLoan.out.term": "Term",
    "tool.autoLoan.out.payment": "Monthly payment",
    "tool.autoLoan.out.totalInterest": "Total interest",
    "tool.autoLoan.out.totalPaid": "Total paid",
    "tool.autoLoan.out.extra": "Extra payment",
    "tool.autoLoan.out.paymentExtra": "Monthly payment (with extra)",
    "tool.autoLoan.out.payoffTime": "Payoff time",
    "tool.autoLoan.out.payoffDate": "Estimated payoff date",
    "tool.autoLoan.out.totalInterestExtra": "Total interest (with extra)",
    "tool.autoLoan.out.interestSaved": "Interest saved",
    "tool.autoLoan.out.firstPayments": "First 12 payments",
    "tool.autoLoan.out.interest": "Interest",
    "tool.autoLoan.out.principal": "Principal",
    "tool.autoLoan.out.balance": "Balance",

    "tool.netWorth.disclaimer": "Estimates only. Not financial advice.",
    "tool.netWorth.assets": "Assets (one per line)",
    "tool.netWorth.assetsPlaceholder": "e.g.\nChecking: 1500\n401(k): 23000",
    "tool.netWorth.liabilities": "Liabilities (one per line)",
    "tool.netWorth.liabilitiesPlaceholder": "e.g.\nCredit card: 1200\nCar loan: 9000",
    "tool.netWorth.showBreakdown": "Show breakdown",
    "tool.netWorth.calculate": "Calculate",
    "tool.netWorth.status.done": "Calculated",
    "tool.netWorth.item.untitled": "Untitled",
    "tool.netWorth.out.netWorth": "Net worth",
    "tool.netWorth.out.assetsTotal": "Total assets",
    "tool.netWorth.out.liabilitiesTotal": "Total liabilities",
    "tool.netWorth.out.debtToAssets": "Debt-to-assets",
    "tool.netWorth.out.assets": "Assets",
    "tool.netWorth.out.liabilities": "Liabilities",
    "tool.netWorth.out.none": "None",
    "tool.netWorth.out.ignoredLines": "Ignored lines",

    "tool.creditUtil.disclaimer": "Estimates only. Not financial advice.",
    "tool.creditUtil.cards": "Cards (one per line: balance / limit)",
    "tool.creditUtil.cardsPlaceholder": "e.g.\nChase: 1200 / 5000\nAmex: 0 / 8000",
    "tool.creditUtil.showBreakdown": "Show per-card breakdown",
    "tool.creditUtil.calculate": "Calculate",
    "tool.creditUtil.status.done": "Calculated",
    "tool.creditUtil.card": "Card",
    "tool.creditUtil.error.noValidLines": "No valid lines found. Use “balance / limit”.",
    "tool.creditUtil.category.unknown": "Unknown",
    "tool.creditUtil.category.excellent": "Excellent (< 10%)",
    "tool.creditUtil.category.good": "Good (< 30%)",
    "tool.creditUtil.category.high": "High (30–49%)",
    "tool.creditUtil.category.veryHigh": "Very high (50%+)",
    "tool.creditUtil.out.totalBalance": "Total balance",
    "tool.creditUtil.out.totalLimit": "Total limit",
    "tool.creditUtil.out.utilization": "Overall utilization",
    "tool.creditUtil.out.category": "Category",
    "tool.creditUtil.out.breakdown": "Per-card breakdown",
    "tool.creditUtil.out.ignoredLines": "Ignored lines",

    "tool.emergencyFund.disclaimer": "Estimates only. Not financial advice.",
    "tool.emergencyFund.expenses": "Monthly expenses",
    "tool.emergencyFund.expensesPlaceholder": "e.g. 3200",
    "tool.emergencyFund.months": "Target months",
    "tool.emergencyFund.presets": "Presets:",
    "tool.emergencyFund.current": "Current emergency savings",
    "tool.emergencyFund.currentPlaceholder": "e.g. 5000",
    "tool.emergencyFund.monthlySave": "Monthly savings (optional)",
    "tool.emergencyFund.monthlySavePlaceholder": "e.g. 300",
    "tool.emergencyFund.showSchedule": "Show first 12 months",
    "tool.emergencyFund.calculate": "Calculate",
    "tool.emergencyFund.status.done": "Calculated",
    "tool.emergencyFund.error.expenses": "Please enter valid monthly expenses",
    "tool.emergencyFund.error.current": "Please enter a valid current savings amount",
    "tool.emergencyFund.error.monthlySave": "Please enter a valid monthly savings amount",
    "tool.emergencyFund.out.expenses": "Monthly expenses",
    "tool.emergencyFund.out.target": "Emergency fund target",
    "tool.emergencyFund.out.months": "months",
    "tool.emergencyFund.out.current": "Current savings",
    "tool.emergencyFund.out.covered": "Months covered",
    "tool.emergencyFund.out.gap": "Gap",
    "tool.emergencyFund.out.monthlySave": "Monthly savings",
    "tool.emergencyFund.out.timeToGoal": "Time to goal",
    "tool.emergencyFund.out.goalDate": "Estimated goal date",
    "tool.emergencyFund.out.firstMonths": "First 12 months",
    "tool.emergencyFund.out.balance": "Balance",
    "tool.emergencyFund.out.remaining": "Remaining",

    "tool.inflation.disclaimer": "Estimates only. Uses a constant inflation rate.",
    "tool.inflation.amount": "Amount",
    "tool.inflation.amountPlaceholder": "e.g. 1000",
    "tool.inflation.mode": "Mode",
    "tool.inflation.mode.inflate": "Future value (inflation)",
    "tool.inflation.mode.deflate": "Value in today’s dollars",
    "tool.inflation.rate": "Inflation rate %",
    "tool.inflation.years": "Years",
    "tool.inflation.showBreakdown": "Show yearly breakdown",
    "tool.inflation.calculate": "Calculate",
    "tool.inflation.status.done": "Calculated",
    "tool.inflation.error.amount": "Please enter a valid amount",
    "tool.inflation.error.generic": "Calculation failed. Please check your inputs.",
    "tool.inflation.out.amount": "Amount",
    "tool.inflation.out.mode": "Mode",
    "tool.inflation.out.rate": "Inflation rate",
    "tool.inflation.out.years": "Years",
    "tool.inflation.out.cumulative": "Cumulative inflation",
    "tool.inflation.out.result": "Result",
    "tool.inflation.out.future": "Future value",
    "tool.inflation.out.today": "Value in today's dollars",
    "tool.inflation.out.breakdown": "Yearly breakdown",
    "tool.inflation.out.year": "Year",

    "tool.fourPercentRule.disclaimer": "Estimates only. Not financial advice.",
    "tool.fourPercentRule.spending": "Annual spending",
    "tool.fourPercentRule.spendingPlaceholder": "e.g. 60000",
    "tool.fourPercentRule.rate": "Withdrawal rate %",
    "tool.fourPercentRule.current": "Current savings (optional)",
    "tool.fourPercentRule.currentPlaceholder": "e.g. 250000",
    "tool.fourPercentRule.showTable": "Show common rate table",
    "tool.fourPercentRule.calculate": "Calculate",
    "tool.fourPercentRule.status.done": "Calculated",
    "tool.fourPercentRule.error.spending": "Please enter a valid annual spending amount",
    "tool.fourPercentRule.error.current": "Please enter a valid current savings amount",
    "tool.fourPercentRule.error.rate": "Please enter a valid withdrawal rate",
    "tool.fourPercentRule.out.spending": "Annual spending",
    "tool.fourPercentRule.out.monthly": "Monthly spending",
    "tool.fourPercentRule.out.rate": "Withdrawal rate",
    "tool.fourPercentRule.out.multiplier": "Multiplier",
    "tool.fourPercentRule.out.required": "Required savings",
    "tool.fourPercentRule.out.current": "Current savings",
    "tool.fourPercentRule.out.gap": "Gap",
    "tool.fourPercentRule.out.gap.ok": "on track",
    "tool.fourPercentRule.out.gap.more": "more needed",
    "tool.fourPercentRule.out.table": "Common rates",

    "tool.fire.disclaimer": "Estimates only. Not financial advice.",
    "tool.fire.expenses": "Annual expenses",
    "tool.fire.expensesPlaceholder": "e.g. 60000",
    "tool.fire.portfolio": "Current portfolio",
    "tool.fire.portfolioPlaceholder": "e.g. 150000",
    "tool.fire.savings": "Annual savings (invested)",
    "tool.fire.savingsPlaceholder": "e.g. 25000",
    "tool.fire.return": "Annual return %",
    "tool.fire.withdrawal": "Withdrawal rate %",
    "tool.fire.showTable": "Show yearly projection",
    "tool.fire.calculate": "Calculate",
    "tool.fire.status.done": "Calculated",
    "tool.fire.year": "year",
    "tool.fire.years": "years",
    "tool.fire.error.expenses": "Please enter a valid annual expenses amount",
    "tool.fire.error.portfolio": "Please enter a valid current portfolio amount",
    "tool.fire.error.savings": "Please enter a valid annual savings amount",
    "tool.fire.error.withdrawal": "Withdrawal rate is invalid",
    "tool.fire.error.unreachable": "Financial independence is not reachable with these inputs.",
    "tool.fire.error.timeout": "Calculation exceeded the time horizon. Please adjust inputs.",
    "tool.fire.out.expenses": "Annual expenses",
    "tool.fire.out.withdrawal": "Withdrawal rate",
    "tool.fire.out.fireNumber": "FIRE number",
    "tool.fire.out.portfolio": "Current portfolio",
    "tool.fire.out.safeSpendNow": "Safe spend now",
    "tool.fire.out.gap": "Gap",
    "tool.fire.out.savings": "Annual savings",
    "tool.fire.out.return": "Annual return",
    "tool.fire.out.savingsRate": "Savings rate",
    "tool.fire.out.timeToFire": "Time to FIRE",
    "tool.fire.out.estimateYear": "Estimated year",
    "tool.fire.out.table": "Yearly projection",
    "tool.fire.out.year": "Year",
    ...
    "tool.rentAfford.amount": "Amount",
    "tool.rentAfford.amountPlaceholder": "e.g. 6000",
    "tool.rentAfford.mode": "Mode",
    "tool.rentAfford.mode.incomeToRent": "Income → Max rent",
    "tool.rentAfford.mode.rentToIncome": "Rent → Required income",
    "tool.rentAfford.percent": "Rent as % of income",
    "tool.rentAfford.presets": "Presets:",
    "tool.rentAfford.calculate": "Calculate",
    "tool.rentAfford.status.done": "Calculated",
    "tool.rentAfford.error.amount": "Please enter a valid amount",
    "tool.rentAfford.error.percent": "Please enter a valid percent",
    "tool.rentAfford.out.mode": "Mode",
    "tool.rentAfford.out.rule": "Rule",
    "tool.rentAfford.out.rentAtMost": "Rent at most",
    "tool.rentAfford.out.incomeAtLeast": "income at least",
    "tool.rentAfford.out.rent": "Rent",
    "tool.rentAfford.out.monthlyIncome": "Monthly income",
    "tool.rentAfford.out.maxRent": "Max rent (monthly)",
    "tool.rentAfford.out.maxAnnualRent": "Max rent (annual)",
    "tool.rentAfford.out.requiredMonthlyIncome": "Required monthly income",
    "tool.rentAfford.out.requiredAnnualIncome": "Required annual income",

    "tool.rentVsBuy.disclaimer": "Estimates only. Not financial advice.",
    "tool.rentVsBuy.rent": "Monthly rent",
    "tool.rentVsBuy.rentPlaceholder": "e.g. 2400",
    "tool.rentVsBuy.rentGrowth": "Rent increase % / year",
    "tool.rentVsBuy.price": "Home price",
    "tool.rentVsBuy.pricePlaceholder": "e.g. 450000",
    "tool.rentVsBuy.downMode": "Down payment",
    "tool.rentVsBuy.downMode.percent": "Percent",
    "tool.rentVsBuy.downMode.amount": "Amount",
    "tool.rentVsBuy.down": "Down payment value",
    "tool.rentVsBuy.downPlaceholder": "e.g. 20",
    "tool.rentVsBuy.apr": "APR %",
    "tool.rentVsBuy.termYears": "Term",
    "tool.rentVsBuy.years": "years",
    "tool.rentVsBuy.closingPct": "Closing costs % (buy)",
    "tool.rentVsBuy.sellingPct": "Selling costs % (sell)",
    "tool.rentVsBuy.tax": "Property tax / year",
    "tool.rentVsBuy.taxPlaceholder": "e.g. 6000",
    "tool.rentVsBuy.insurance": "Insurance / year",
    "tool.rentVsBuy.insurancePlaceholder": "e.g. 1200",
    "tool.rentVsBuy.hoa": "HOA / month",
    "tool.rentVsBuy.hoaPlaceholder": "e.g. 0",
    "tool.rentVsBuy.maintenancePct": "Maintenance % / year",
    "tool.rentVsBuy.appreciation": "Home appreciation % / year",
    "tool.rentVsBuy.horizon": "Time horizon (years)",
    "tool.rentVsBuy.showTable": "Show yearly table",
    "tool.rentVsBuy.calculate": "Calculate",
    "tool.rentVsBuy.status.done": "Calculated",
    "tool.rentVsBuy.year": "year",
    "tool.rentVsBuy.error.rent": "Please enter a valid monthly rent",
    "tool.rentVsBuy.error.price": "Please enter a valid home price",
    "tool.rentVsBuy.error.down": "Please enter a valid down payment",
    "tool.rentVsBuy.error.generic": "Calculation failed. Please check your inputs.",
    "tool.rentVsBuy.out.horizon": "Time horizon",
    "tool.rentVsBuy.out.rent": "Rent",
    "tool.rentVsBuy.out.rentTotal": "Total rent paid",
    "tool.rentVsBuy.out.price": "Home price",
    "tool.rentVsBuy.out.down": "Down payment",
    "tool.rentVsBuy.out.loan": "Loan amount",
    "tool.rentVsBuy.out.apr": "APR",
    "tool.rentVsBuy.out.payment": "Monthly payment",
    "tool.rentVsBuy.out.closing": "Closing costs",
    "tool.rentVsBuy.out.selling": "Selling costs",
    "tool.rentVsBuy.out.appreciation": "Appreciation",
    "tool.rentVsBuy.out.maintenance": "Maintenance",
    "tool.rentVsBuy.out.homeValue": "Home value",
    "tool.rentVsBuy.out.balance": "Loan balance",
    "tool.rentVsBuy.out.buyNet": "Net cost to buy",
    "tool.rentVsBuy.out.breakEven": "Break-even",
    "tool.rentVsBuy.out.none": "None",
    "tool.rentVsBuy.out.table": "Yearly table",
    "tool.rentVsBuy.out.year": "Year",

    "tool.dti.disclaimer": "Estimates only. Not financial advice.",
    "tool.dti.income": "Gross monthly income",
    "tool.dti.incomePlaceholder": "e.g. 6500",
    "tool.dti.housing": "Housing (rent/mortgage)",
    "tool.dti.housingPlaceholder": "e.g. 1800",
    "tool.dti.car": "Car payment",
    "tool.dti.carPlaceholder": "e.g. 350",
    "tool.dti.student": "Student loans",
    "tool.dti.studentPlaceholder": "e.g. 0",
    "tool.dti.credit": "Credit cards (minimums)",
    "tool.dti.creditPlaceholder": "e.g. 120",
    "tool.dti.other": "Other debts",
    "tool.dti.otherPlaceholder": "e.g. 0",
    "tool.dti.calculate": "Calculate",
    "tool.dti.status.done": "Calculated",
    "tool.dti.error.income": "Please enter a valid monthly income",
    "tool.dti.error.debt": "Please enter a valid amount for {field}",
    "tool.dti.category.unknown": "Unknown",
    "tool.dti.category.low": "Low (< 20%)",
    "tool.dti.category.ok": "OK (< 36%)",
    "tool.dti.category.borderline": "Borderline (36–43%)",
    "tool.dti.category.high": "High (43%+)",
    "tool.dti.out.income": "Monthly income",
    "tool.dti.out.totalDebt": "Total monthly debt",
    "tool.dti.out.dti": "DTI",
    "tool.dti.out.category": "Category",
    "tool.dti.out.breakdown": "Breakdown",
    ...
    "tool.debtPayoffPlan.disclaimer": "Estimates only. Not financial advice.",
    "tool.debtPayoffPlan.debts": "Debts (one per line)",
    "tool.debtPayoffPlan.debtsPlaceholder": "e.g.\nVisa: 3500 24.99 120\nCar loan: 9000 6.50 200",
    "tool.debtPayoffPlan.method": "Method",
    "tool.debtPayoffPlan.method.snowball": "Snowball (smallest balance first)",
    "tool.debtPayoffPlan.method.avalanche": "Avalanche (highest APR first)",
    "tool.debtPayoffPlan.method.snowballShort": "Snowball",
    "tool.debtPayoffPlan.method.avalancheShort": "Avalanche",
    "tool.debtPayoffPlan.extra": "Extra payment / month",
    "tool.debtPayoffPlan.extraPlaceholder": "e.g. 200",
    "tool.debtPayoffPlan.rollover": "Rollover paid-off minimum payments",
    "tool.debtPayoffPlan.showSchedule": "Show first 12 months",
    "tool.debtPayoffPlan.calculate": "Calculate",
    "tool.debtPayoffPlan.debt": "Debt",
    "tool.debtPayoffPlan.yes": "Yes",
    "tool.debtPayoffPlan.no": "No",
    "tool.debtPayoffPlan.months": "months",
    "tool.debtPayoffPlan.years": "years",
    "tool.debtPayoffPlan.status.done": "Calculated",
    "tool.debtPayoffPlan.error.extra": "Please enter a valid extra payment amount",
    "tool.debtPayoffPlan.error.noDebts": "Please add at least one debt line (balance APR min-payment).",
    "tool.debtPayoffPlan.error.budget": "Monthly budget must be greater than 0.",
    "tool.debtPayoffPlan.error.noProgress":
      "Minimum payments are too low to cover interest (balances will grow).",
    "tool.debtPayoffPlan.error.timeout": "Calculation timed out. Please adjust your inputs.",
    "tool.debtPayoffPlan.out.debts": "Debts",
    "tool.debtPayoffPlan.out.method": "Method",
    "tool.debtPayoffPlan.out.extra": "Extra payment",
    "tool.debtPayoffPlan.out.rollover": "Rollover",
    "tool.debtPayoffPlan.out.monthlyBudget": "Monthly budget",
    "tool.debtPayoffPlan.out.payoffTime": "Payoff time",
    "tool.debtPayoffPlan.out.payoffDate": "Estimated payoff date",
    "tool.debtPayoffPlan.out.totalPaid": "Total paid",
    "tool.debtPayoffPlan.out.totalInterest": "Total interest",
    "tool.debtPayoffPlan.out.debtsLeft": "Debts left",
    "tool.debtPayoffPlan.out.ignoredLines": "Ignored lines",
    "tool.debtPayoffPlan.out.payoffOrder": "Payoff order",
    "tool.debtPayoffPlan.out.firstMonths": "First 12 months",
    "tool.debtPayoffPlan.out.balance": "Balance",
    "tool.debtPayoffPlan.out.payment": "Payment",
    "tool.debtPayoffPlan.out.interest": "Interest",
    ...
    "tool.investmentFees.disclaimer": "Estimates only. Not financial advice.",
    "tool.investmentFees.principal": "Initial amount",
    "tool.investmentFees.principalPlaceholder": "e.g. 10000",
    "tool.investmentFees.contribution": "Contribution / month",
    "tool.investmentFees.contributionPlaceholder": "e.g. 300",
    "tool.investmentFees.return": "Annual return % (before fees)",
    "tool.investmentFees.fee": "Annual fee % (expense ratio)",
    "tool.investmentFees.years": "Years",
    "tool.investmentFees.timing": "Contribution timing",
    "tool.investmentFees.timing.end": "End of month",
    "tool.investmentFees.timing.start": "Start of month",
    "tool.investmentFees.showBreakdown": "Show yearly breakdown",
    "tool.investmentFees.calculate": "Calculate",
    "tool.investmentFees.status.done": "Calculated",
    "tool.investmentFees.error.principal": "Please enter a valid initial amount",
    "tool.investmentFees.error.contribution": "Please enter a valid monthly contribution",
    "tool.investmentFees.error.years": "Please enter a valid number of years",
    "tool.investmentFees.out.principal": "Initial amount",
    "tool.investmentFees.out.contribution": "Contribution / month",
    "tool.investmentFees.out.return": "Annual return",
    "tool.investmentFees.out.fee": "Annual fee",
    "tool.investmentFees.out.years": "Years",
    "tool.investmentFees.out.timing": "Contribution timing",
    "tool.investmentFees.out.totalContrib": "Total contributions",
    "tool.investmentFees.out.finalNoFee": "Final value (no fee)",
    "tool.investmentFees.out.finalWithFee": "Final value (with fee)",
    "tool.investmentFees.out.diff": "Difference",
    "tool.investmentFees.out.feesPaid": "Fees paid",
    "tool.investmentFees.out.breakdown": "Yearly breakdown",
    "tool.investmentFees.out.year": "Year",
    "tool.investmentFees.out.noFee": "No fee",
    "tool.investmentFees.out.withFee": "With fee",

    "tool.savingsGoal.disclaimer": "Estimates only. Not financial advice.",
    "tool.savingsGoal.mode": "Mode",
    "tool.savingsGoal.mode.time": "Time to goal",
    "tool.savingsGoal.mode.monthly": "Monthly savings needed",
    "tool.savingsGoal.start": "Starting amount",
    "tool.savingsGoal.startPlaceholder": "e.g. 1000",
    "tool.savingsGoal.goal": "Goal amount",
    "tool.savingsGoal.goalPlaceholder": "e.g. 20000",
    "tool.savingsGoal.monthly": "Monthly savings",
    "tool.savingsGoal.monthlyPlaceholder": "e.g. 300",
    "tool.savingsGoal.targetTime": "Target time",
    "tool.savingsGoal.years": "years",
    "tool.savingsGoal.months": "months",
    "tool.savingsGoal.rate": "Interest rate (APY %) (optional)",
    "tool.savingsGoal.timing": "Deposit timing",
    "tool.savingsGoal.timing.end": "End of month",
    "tool.savingsGoal.timing.start": "Start of month",
    "tool.savingsGoal.showSchedule": "Show first 12 months",
    "tool.savingsGoal.calculate": "Calculate",
    "tool.savingsGoal.status.done": "Calculated",
    "tool.savingsGoal.error.goal": "Please enter a valid goal amount",
    "tool.savingsGoal.error.start": "Please enter a valid starting amount",
    "tool.savingsGoal.error.monthly": "Please enter a valid monthly savings amount",
    "tool.savingsGoal.error.targetTime": "Please enter a valid target time",
    "tool.savingsGoal.error.unreachable": "Goal is not reachable with these inputs.",
    "tool.savingsGoal.error.generic": "Calculation failed. Please check your inputs.",
    "tool.savingsGoal.out.mode": "Mode",
    "tool.savingsGoal.out.start": "Starting amount",
    "tool.savingsGoal.out.goal": "Goal amount",
    "tool.savingsGoal.out.apy": "APY",
    "tool.savingsGoal.out.timing": "Deposit timing",
    "tool.savingsGoal.out.targetTime": "Target time",
    "tool.savingsGoal.out.requiredMonthly": "Required monthly savings",
    "tool.savingsGoal.out.monthly": "Monthly savings",
    "tool.savingsGoal.out.timeToGoal": "Time to goal",
    "tool.savingsGoal.out.goalDate": "Estimated goal date",
    "tool.savingsGoal.out.endBalance": "Ending balance",
    "tool.savingsGoal.out.firstMonths": "First 12 months",
    "tool.savingsGoal.out.deposit": "Deposit",
    "tool.savingsGoal.out.interest": "Interest",
    "tool.savingsGoal.out.balance": "Balance",

    "tool.retirement.disclaimer": "Estimates only. Not financial advice.",
    "tool.retirement.currentAge": "Current age",
    "tool.retirement.retireAge": "Retirement age",
    "tool.retirement.balance": "Current savings",
    "tool.retirement.balancePlaceholder": "e.g. 20000",
    "tool.retirement.salary": "Annual salary",
    "tool.retirement.salaryPlaceholder": "e.g. 80000",
    "tool.retirement.employeePct": "Your contribution %",
    "tool.retirement.matchRate": "Employer match %",
    "tool.retirement.matchCap": "Match up to % of salary",
    "tool.retirement.return": "Annual return %",
    "tool.retirement.growth": "Salary growth %",
    "tool.retirement.showTable": "Show yearly breakdown",
    "tool.retirement.calculate": "Calculate",
    "tool.retirement.status.done": "Calculated",
    "tool.retirement.error.ages": "Retirement age must be greater than current age",
    "tool.retirement.error.balance": "Please enter a valid current savings amount",
    "tool.retirement.error.salary": "Please enter a valid annual salary",
    "tool.retirement.years": "years",
    "tool.retirement.year": "year",
    "tool.retirement.out.currentAge": "Current age",
    "tool.retirement.out.retireAge": "Retirement age",
    "tool.retirement.out.horizon": "Time horizon",
    "tool.retirement.out.startBalance": "Starting balance",
    "tool.retirement.out.salary": "Salary",
    "tool.retirement.out.employeePct": "Your contribution",
    "tool.retirement.out.employerMatch": "Employer match",
    "tool.retirement.out.matchUpTo": "up to",
    "tool.retirement.out.contribNow": "Est. annual contributions (current salary)",
    "tool.retirement.out.assumedReturn": "Assumed return",
    "tool.retirement.out.salaryGrowth": "Salary growth",
    "tool.retirement.out.finalBalance": "Est. balance at retirement",
    "tool.retirement.out.totalEmployee": "Total you contribute",
    "tool.retirement.out.totalEmployer": "Total employer match",
    "tool.retirement.out.totalContrib": "Total contributions",
    "tool.retirement.out.growth": "Est. investment growth",
    "tool.retirement.out.yearlyBreakdown": "Yearly breakdown",
    "tool.retirement.out.age": "Age",
    "tool.retirement.out.balance": "Balance",

    "tool.cagr.start": "Start value",
    "tool.cagr.startPlaceholder": "e.g. 10000",
    "tool.cagr.end": "End value",
    "tool.cagr.endPlaceholder": "e.g. 16000",
    "tool.cagr.years": "Years",
    "tool.cagr.presets": "Presets:",
    "tool.cagr.calculate": "Calculate",
    "tool.cagr.status.done": "Calculated",
    "tool.cagr.error.start": "Please enter a valid start value",
    "tool.cagr.error.end": "Please enter a valid end value",
    "tool.cagr.error.years": "Please enter a valid number of years",
    "tool.cagr.error.generic": "Calculation failed. Please check your inputs.",
    "tool.cagr.out.start": "Start value",
    "tool.cagr.out.end": "End value",
    "tool.cagr.out.years": "Years",
    "tool.cagr.out.multiple": "Multiple",
    "tool.cagr.out.totalReturn": "Total return",
    "tool.cagr.out.cagr": "CAGR",
    "tool.cagr.out.monthly": "Monthly equivalent",
  ...
  zh: {
    ...
    "runs.title": "运行记录",
    "runs.caption": "运行历史",
    "runs.recent": "最近 {count} 次运行。",
    "runs.table.finished": "完成时间",
    "runs.table.sources": "来源",
    "runs.table.items": "条目",
    "runs.table.trend": "趋势",
    "runs.table.cleanup": "清理",
    "runs.table.articles": "文章",
    "runs.sourcesCell": "成功 {ok} / 失败 {failed} / 暂停 {paused}",
    ...
    "sources.table.category": "分类",
    "sources.table.status": "状态",
    "sources.table.lastFetch": "上次抓取",
    "sources.table.lastSuccess": "上次成功",
    "sources.table.paused": "暂停",
    "sources.table.added": "新增",
    "sources.table.dup": "去重",
    "sources.table.failStreak": "连续失败",
    ...
    "tools.item.discount.title": "折扣计算器",
    "tools.item.discount.desc": "计算折扣金额与折后价格（可选销售税/数量）。",
    ...
    "tools.item.home-affordability.title": "房屋承受能力计算器",
    "tools.item.home-affordability.desc": "根据收入、负债与贷款假设，估算你能承受的房价。",
    "tools.item.loan.title": "贷款计算器",
    "tools.item.loan.desc": "计算月供、总利息与额外还款后的还清时间。",
    "tools.item.budget-50-30-20.title": "50/30/20 预算计算器",
    "tools.item.budget-50-30-20.desc": "用 50/30/20 法则分配月收入：必需、想要与储蓄/还债。",
    "tools.item.apr-apy.title": "APR ↔ APY 转换器",
    "tools.item.apr-apy.desc": "按复利频率（每日/每月/每季/每年）在 APR 与 APY 之间转换。",
    "tools.item.salary.title": "薪资计算器",
    "tools.item.salary.desc": "年薪与时薪互转，并给出月薪/双周薪/周薪等。",
    "tools.item.take-home-pay.title": "到手工资计算器",
    "tools.item.take-home-pay.desc": "按自定义税率与扣除项估算每次发薪的到手工资。",
    "tools.item.auto-loan.title": "车贷计算器",
    "tools.item.auto-loan.desc": "按车价、置换、首付、销售税与手续费估算车贷月供与融资金额。",
    "tools.item.net-worth.title": "净资产计算器",
    "tools.item.net-worth.desc": "根据资产与负债计算净资产（本地计算）。",
    "tools.item.credit-utilization.title": "信用卡利用率计算器",
    "tools.item.credit-utilization.desc": "计算每张卡与整体的信用卡利用率（余额 ÷ 额度）。",
    "tools.item.emergency-fund.title": "应急基金计算器",
    "tools.item.emergency-fund.desc": "估算应急基金目标金额及达到目标所需时间。",
    "tools.item.inflation.title": "通胀计算器",
    "tools.item.inflation.desc": "使用通胀率估算未来金额或折算为今日购买力。",
    "tools.item.four-percent-rule.title": "4% 法则计算器",
    "tools.item.four-percent-rule.desc": "使用提取率（如 4%）估算退休所需储蓄。",
    "tools.item.fire.title": "FIRE（财务自由）计算器",
    "tools.item.fire.desc": "计算 FIRE 目标金额，并估算达到财务自由所需年数。",
    "tools.item.gas-cost.title": "油费计算器",
    "tools.item.gas-cost.desc": "按里程、MPG 与油价估算用油量与总油费（本地计算）。",
    "tools.item.rent-affordability.title": "租房承受能力计算器",
    "tools.item.rent-affordability.desc": "按租金占收入比例估算可承受租金或所需收入。",
    "tools.item.rent-vs-buy.title": "租房 vs 买房计算器",
    "tools.item.rent-vs-buy.desc": "对比租房与买房成本，估算盈亏平衡点。",
    "tools.item.debt-to-income.title": "债务收入比（DTI）计算器",
    "tools.item.debt-to-income.desc": "根据月收入与各项月度负债计算 DTI。",
    "tools.item.credit-card-payoff.title": "信用卡还款计算器",
    "tools.item.credit-card-payoff.desc": "估算信用卡还清时间与利息支出。",
    "tools.item.debt-payoff-plan.title": "债务还款规划器",
    "tools.item.debt-payoff-plan.desc": "用雪球/雪崩策略规划多笔债务的还清时间与总利息。",
    "tools.item.compound-interest.title": "复利计算器",
    "tools.item.compound-interest.desc": "按月投入并复利增长，估算未来金额。",
    "tools.item.investment-fees.title": "投资费用计算器",
    "tools.item.investment-fees.desc": "估算费用率（Expense Ratio）对长期收益的影响。",
    "tools.item.savings-goal.title": "储蓄目标计算器",
    "tools.item.savings-goal.desc": "估算达到储蓄目标所需时间，或反推每月需要存多少钱。",
    "tools.item.retirement.title": "401(k)/退休储蓄计算器",
    "tools.item.retirement.desc": "考虑个人缴纳与雇主匹配，估算退休储蓄增长。",
    "tools.item.cagr.title": "CAGR 计算器",
    "tools.item.cagr.desc": "计算复合年增长率（CAGR）与总回报。",
    "tools.item.horoscope.title": "每日星座运势",
    "tools.item.horoscope.desc": "按星座生成每日运势（仅供娱乐）。",
    "tools.item.zodiac-compatibility.title": "星座匹配度",
    "tools.item.zodiac-compatibility.desc": "按星座生成匹配度分数与建议（仅供娱乐）。",
    ...
    "tool.discount.price": "价格",
    "tool.discount.pricePlaceholder": "例如：49.99",
    "tool.discount.discountPercent": "折扣 %",
    "tool.discount.taxRate": "销售税 %（可选）",
    "tool.discount.qty": "数量",
    "tool.discount.presets": "常用：",
    "tool.discount.calculate": "计算",
    "tool.discount.status.done": "计算完成",
    "tool.discount.error.price": "请输入合法价格",
    "tool.discount.error.discountPercent": "请输入合法折扣比例",
    "tool.discount.error.taxRate": "请输入合法税率",
    "tool.discount.out.price": "价格",
    "tool.discount.out.discountPercent": "折扣",
    "tool.discount.out.taxRate": "销售税",
    "tool.discount.out.qty": "数量",
    "tool.discount.out.subtotal": "小计",
    "tool.discount.out.discountAmount": "折扣金额",
    "tool.discount.out.afterDiscount": "折后小计",
    "tool.discount.out.tax": "税额",
    "tool.discount.out.total": "合计",
    "tool.discount.out.perItem": "单件",
    ...
    "tool.zodiacCompat.disclaimer": "仅供娱乐，不构成任何建议。",
    "tool.zodiacCompat.you": "你的星座",
    "tool.zodiacCompat.them": "对方星座",
    "tool.zodiacCompat.type": "类型",
    "tool.zodiacCompat.type.love": "恋爱",
    "tool.zodiacCompat.type.friendship": "友情",
    "tool.zodiacCompat.type.work": "工作",
    "tool.zodiacCompat.generate": "生成",
    "tool.zodiacCompat.status.done": "已生成",
    "tool.zodiacCompat.out.you": "你",
    "tool.zodiacCompat.out.them": "对方",
    "tool.zodiacCompat.out.type": "类型",
    "tool.zodiacCompat.out.elements": "元素",
    "tool.zodiacCompat.out.score": "匹配度",
    "tool.zodiacCompat.out.strengths": "优势",
    "tool.zodiacCompat.out.challenges": "挑战",
    "tool.zodiacCompat.out.tip": "建议",
    ...
    "tool.homeAfford.disclaimer": "仅供估算，不构成理财建议。",
    "tool.homeAfford.income": "税前月收入",
    "tool.homeAfford.incomePlaceholder": "例如：8000",
    "tool.homeAfford.debts": "其他月度负债",
    "tool.homeAfford.debtsPlaceholder": "例如：400",
    "tool.homeAfford.housingPct": "住房开支占收入 %",
    "tool.homeAfford.dtiPct": "最大 DTI %",
    "tool.homeAfford.downMode": "首付",
    "tool.homeAfford.downMode.percent": "百分比",
    "tool.homeAfford.downMode.amount": "金额",
    "tool.homeAfford.down": "首付数值",
    "tool.homeAfford.downPlaceholder": "例如：20",
    "tool.homeAfford.apr": "APR %",
    "tool.homeAfford.termYears": "期限",
    "tool.homeAfford.years": "年",
    "tool.homeAfford.tax": "房产税 / 年",
    "tool.homeAfford.taxPlaceholder": "例如：6000",
    "tool.homeAfford.insurance": "保险 / 年",
    "tool.homeAfford.insurancePlaceholder": "例如：1200",
    "tool.homeAfford.hoa": "HOA / 月",
    "tool.homeAfford.hoaPlaceholder": "例如：0",
    "tool.homeAfford.pmi": "PMI / 月（可选）",
    "tool.homeAfford.pmiPlaceholder": "例如：0",
    "tool.homeAfford.calculate": "计算",
    "tool.homeAfford.status.done": "计算完成",
    "tool.homeAfford.error.income": "请输入合法的税前月收入",
    "tool.homeAfford.error.debts": "请输入合法的其他月度负债",
    "tool.homeAfford.error.allowed": "可承受的住房月支出 ≤ 0，请检查输入",
    "tool.homeAfford.error.extras": "税/保险/HOA/PMI 等费用过高，导致可用于本金+利息的额度 ≤ 0",
    "tool.homeAfford.error.down": "请输入合法的首付金额/比例",
    "tool.homeAfford.error.generic": "计算失败，请检查输入",
    "tool.homeAfford.out.income": "月收入",
    "tool.homeAfford.out.debts": "其他月度负债",
    "tool.homeAfford.out.housingLimit": "住房占比上限",
    "tool.homeAfford.out.dtiLimit": "DTI 上限",
    "tool.homeAfford.out.allowed": "可承受住房月支出",
    "tool.homeAfford.out.extras": "额外费用（月）",
    "tool.homeAfford.out.maxPI": "最大本金+利息（月）",
    "tool.homeAfford.out.loanAmount": "可贷金额",
    "tool.homeAfford.out.downPayment": "首付",
    "tool.homeAfford.out.homePrice": "可承受房价",
    "tool.homeAfford.out.apr": "APR",
    "tool.homeAfford.out.term": "期限",
    "tool.homeAfford.out.pi": "本金+利息（P&I）",
    "tool.homeAfford.out.monthlyTotal": "月总支出",
    ...
    "tool.budget503020.income": "月收入",
    "tool.budget503020.incomePlaceholder": "例如：4500",
    "tool.budget503020.needsPct": "必需 %",
    "tool.budget503020.wantsPct": "想要 %",
    "tool.budget503020.savingsPct": "储蓄/还债 %",
    "tool.budget503020.reset": "重置为 50/30/20",
    "tool.budget503020.calculate": "计算",
    "tool.budget503020.status.done": "计算完成",
    "tool.budget503020.error.income": "请输入合法月收入",
    "tool.budget503020.error.percentSum": "百分比之和必须为 100%（当前：{sum}）",
    "tool.budget503020.out.income": "月收入",
    "tool.budget503020.out.rule": "法则（必需 / 想要 / 储蓄）",
    "tool.budget503020.out.needs": "必需",
    "tool.budget503020.out.wants": "想要",
    "tool.budget503020.out.savings": "储蓄/还债",
    "tool.budget503020.out.monthly": "每月",
    "tool.budget503020.out.weekly": "每周",
    "tool.budget503020.out.daily": "每天",

    "tool.aprApy.rate": "利率 %",
    "tool.aprApy.ratePlaceholder": "例如：5.00",
    "tool.aprApy.mode": "模式",
    "tool.aprApy.mode.aprToApy": "APR → APY",
    "tool.aprApy.mode.apyToApr": "APY → APR",
    "tool.aprApy.compounding": "复利频率",
    "tool.aprApy.compound.daily": "每日（365）",
    "tool.aprApy.compound.monthly": "每月（12）",
    "tool.aprApy.compound.quarterly": "每季（4）",
    "tool.aprApy.compound.annual": "每年（1）",
    "tool.aprApy.compound.continuous": "连续复利",
    "tool.aprApy.calculate": "计算",
    "tool.aprApy.status.done": "计算完成",
    "tool.aprApy.error.rate": "请输入合法利率",
    "tool.aprApy.error.generic": "计算失败，请检查输入",
    "tool.aprApy.out.mode": "模式",
    "tool.aprApy.out.compounding": "复利频率",
    "tool.aprApy.out.input": "输入",
    "tool.aprApy.out.output": "输出",
    ...
    "tool.takeHomePay.disclaimer": "仅供估算，不构成税务建议。",
    "tool.takeHomePay.gross": "税前工资",
    "tool.takeHomePay.grossPlaceholder": "例如：2500",
    "tool.takeHomePay.frequency": "发薪频率",
    "tool.takeHomePay.frequency.weekly": "每周（52）",
    "tool.takeHomePay.frequency.biweekly": "双周（26）",
    "tool.takeHomePay.frequency.semimonthly": "半月（24）",
    "tool.takeHomePay.frequency.monthly": "每月（12）",
    "tool.takeHomePay.pretax": "税前扣除（每期）",
    "tool.takeHomePay.pretaxPlaceholder": "例如：150",
    "tool.takeHomePay.federal": "联邦税 %",
    "tool.takeHomePay.state": "州税 %",
    "tool.takeHomePay.local": "地方税 %",
    "tool.takeHomePay.fica": "FICA %",
    "tool.takeHomePay.posttax": "税后扣除（每期）",
    "tool.takeHomePay.posttaxPlaceholder": "例如：0",
    "tool.takeHomePay.showAnnual": "显示年度汇总",
    "tool.takeHomePay.calculate": "计算",
    "tool.takeHomePay.status.done": "计算完成",
    "tool.takeHomePay.error.gross": "请输入合法的税前工资金额",
    "tool.takeHomePay.error.pretax": "请输入合法的税前扣除金额",
    "tool.takeHomePay.error.posttax": "请输入合法的税后扣除金额",
    "tool.takeHomePay.error.net": "到手工资为负数，请检查扣除项与税率。",
    "tool.takeHomePay.out.gross": "税前工资",
    "tool.takeHomePay.out.frequency": "频率",
    "tool.takeHomePay.out.pretax": "税前扣除",
    "tool.takeHomePay.out.taxable": "计税工资",
    "tool.takeHomePay.out.federal": "联邦税",
    "tool.takeHomePay.out.state": "州税",
    "tool.takeHomePay.out.local": "地方税",
    "tool.takeHomePay.out.fica": "FICA",
    "tool.takeHomePay.out.taxesTotal": "税额合计",
    "tool.takeHomePay.out.posttax": "税后扣除",
    "tool.takeHomePay.out.net": "到手工资",
    "tool.takeHomePay.out.takeHomeRate": "到手比例",
    "tool.takeHomePay.out.annualGross": "年度税前",
    "tool.takeHomePay.out.annualPretax": "年度税前扣除",
    "tool.takeHomePay.out.annualTaxable": "年度计税工资",
    "tool.takeHomePay.out.annualTaxes": "年度税额",
    "tool.takeHomePay.out.annualPosttax": "年度税后扣除",
    "tool.takeHomePay.out.annualNet": "年度到手",

    "tool.autoLoan.disclaimer": "仅供估算，不构成理财建议。",
    "tool.autoLoan.price": "车价",
    "tool.autoLoan.pricePlaceholder": "例如：30000",
    "tool.autoLoan.tradeIn": "置换/旧车抵扣",
    "tool.autoLoan.tradeInPlaceholder": "例如：5000",
    "tool.autoLoan.down": "首付",
    "tool.autoLoan.downPlaceholder": "例如：3000",
    "tool.autoLoan.taxRate": "销售税 %",
    "tool.autoLoan.taxAfterTradeIn": "先扣除置换再计税",
    "tool.autoLoan.fees": "手续费（上牌/文件等）",
    "tool.autoLoan.feesPlaceholder": "例如：500",
    "tool.autoLoan.apr": "APR %",
    "tool.autoLoan.termMonths": "期限",
    "tool.autoLoan.termPresets": "常用：",
    "tool.autoLoan.months": "个月",
    "tool.autoLoan.years": "年",
    "tool.autoLoan.extra": "每月额外还款",
    "tool.autoLoan.extraPlaceholder": "例如：50",
    "tool.autoLoan.showSchedule": "显示前 12 期明细",
    "tool.autoLoan.calculate": "计算",
    "tool.autoLoan.status.done": "计算完成",
    "tool.autoLoan.error.price": "请输入合法的车价",
    "tool.autoLoan.error.tradeIn": "请输入合法的置换金额",
    "tool.autoLoan.error.down": "请输入合法的首付金额",
    "tool.autoLoan.error.fees": "请输入合法的手续费金额",
    "tool.autoLoan.error.extra": "请输入合法的额外还款金额",
    "tool.autoLoan.error.generic": "计算失败，请检查输入。",
    "tool.autoLoan.out.price": "车价",
    "tool.autoLoan.out.tradeIn": "置换抵扣",
    "tool.autoLoan.out.down": "首付",
    "tool.autoLoan.out.fees": "手续费",
    "tool.autoLoan.out.taxRate": "税率",
    "tool.autoLoan.out.taxableAmount": "计税金额",
    "tool.autoLoan.out.tax": "税额",
    "tool.autoLoan.out.amountFinanced": "融资金额",
    "tool.autoLoan.out.apr": "APR",
    "tool.autoLoan.out.term": "期限",
    "tool.autoLoan.out.payment": "月供",
    "tool.autoLoan.out.totalInterest": "总利息",
    "tool.autoLoan.out.totalPaid": "总支付",
    "tool.autoLoan.out.extra": "额外还款",
    "tool.autoLoan.out.paymentExtra": "月供（含额外还款）",
    "tool.autoLoan.out.payoffTime": "还清时间",
    "tool.autoLoan.out.payoffDate": "预计还清日期",
    "tool.autoLoan.out.totalInterestExtra": "总利息（含额外还款）",
    "tool.autoLoan.out.interestSaved": "节省利息",
    "tool.autoLoan.out.firstPayments": "前 12 期",
    "tool.autoLoan.out.interest": "利息",
    "tool.autoLoan.out.principal": "本金",
    "tool.autoLoan.out.balance": "余额",

    "tool.netWorth.disclaimer": "仅供估算，不构成理财建议。",
    "tool.netWorth.assets": "资产（每行一项）",
    "tool.netWorth.assetsPlaceholder": "例如：\n现金: 1500\n401(k): 23000",
    "tool.netWorth.liabilities": "负债（每行一项）",
    "tool.netWorth.liabilitiesPlaceholder": "例如：\n信用卡: 1200\n车贷: 9000",
    "tool.netWorth.showBreakdown": "显示明细",
    "tool.netWorth.calculate": "计算",
    "tool.netWorth.status.done": "计算完成",
    "tool.netWorth.item.untitled": "未命名",
    "tool.netWorth.out.netWorth": "净资产",
    "tool.netWorth.out.assetsTotal": "资产合计",
    "tool.netWorth.out.liabilitiesTotal": "负债合计",
    "tool.netWorth.out.debtToAssets": "负债/资产比",
    "tool.netWorth.out.assets": "资产",
    "tool.netWorth.out.liabilities": "负债",
    "tool.netWorth.out.none": "无",
    "tool.netWorth.out.ignoredLines": "已忽略行数",

    "tool.creditUtil.disclaimer": "仅供估算，不构成理财建议。",
    "tool.creditUtil.cards": "信用卡（每行：余额 / 额度）",
    "tool.creditUtil.cardsPlaceholder": "例如：\nChase: 1200 / 5000\nAmex: 0 / 8000",
    "tool.creditUtil.showBreakdown": "显示每张卡明细",
    "tool.creditUtil.calculate": "计算",
    "tool.creditUtil.status.done": "计算完成",
    "tool.creditUtil.card": "卡",
    "tool.creditUtil.error.noValidLines": "没有找到有效行，请使用“余额 / 额度”。",
    "tool.creditUtil.category.unknown": "未知",
    "tool.creditUtil.category.excellent": "优秀（< 10%）",
    "tool.creditUtil.category.good": "良好（< 30%）",
    "tool.creditUtil.category.high": "偏高（30–49%）",
    "tool.creditUtil.category.veryHigh": "很高（50%+）",
    "tool.creditUtil.out.totalBalance": "余额合计",
    "tool.creditUtil.out.totalLimit": "额度合计",
    "tool.creditUtil.out.utilization": "整体利用率",
    "tool.creditUtil.out.category": "分类",
    "tool.creditUtil.out.breakdown": "每张卡明细",
    "tool.creditUtil.out.ignoredLines": "已忽略行数",

    "tool.emergencyFund.disclaimer": "仅供估算，不构成理财建议。",
    "tool.emergencyFund.expenses": "每月开销",
    "tool.emergencyFund.expensesPlaceholder": "例如：3200",
    "tool.emergencyFund.months": "目标月数",
    "tool.emergencyFund.presets": "常用：",
    "tool.emergencyFund.current": "当前应急储蓄",
    "tool.emergencyFund.currentPlaceholder": "例如：5000",
    "tool.emergencyFund.monthlySave": "每月存入（可选）",
    "tool.emergencyFund.monthlySavePlaceholder": "例如：300",
    "tool.emergencyFund.showSchedule": "显示前 12 个月",
    "tool.emergencyFund.calculate": "计算",
    "tool.emergencyFund.status.done": "计算完成",
    "tool.emergencyFund.error.expenses": "请输入合法每月开销",
    "tool.emergencyFund.error.current": "请输入合法当前储蓄金额",
    "tool.emergencyFund.error.monthlySave": "请输入合法每月存入金额",
    "tool.emergencyFund.out.expenses": "每月开销",
    "tool.emergencyFund.out.target": "应急基金目标",
    "tool.emergencyFund.out.months": "个月",
    "tool.emergencyFund.out.current": "当前储蓄",
    "tool.emergencyFund.out.covered": "可覆盖月数",
    "tool.emergencyFund.out.gap": "差额",
    "tool.emergencyFund.out.monthlySave": "每月存入",
    "tool.emergencyFund.out.timeToGoal": "达到目标所需",
    "tool.emergencyFund.out.goalDate": "预计达到日期",
    "tool.emergencyFund.out.firstMonths": "前 12 个月",
    "tool.emergencyFund.out.balance": "余额",
    "tool.emergencyFund.out.remaining": "剩余差额",

    "tool.inflation.disclaimer": "仅供估算，使用固定通胀率。",
    "tool.inflation.amount": "金额",
    "tool.inflation.amountPlaceholder": "例如：1000",
    "tool.inflation.mode": "模式",
    "tool.inflation.mode.inflate": "未来价值（通胀）",
    "tool.inflation.mode.deflate": "折算为今日购买力",
    "tool.inflation.rate": "通胀率 %",
    "tool.inflation.years": "年数",
    "tool.inflation.showBreakdown": "显示年度明细",
    "tool.inflation.calculate": "计算",
    "tool.inflation.status.done": "计算完成",
    "tool.inflation.error.amount": "请输入合法金额",
    "tool.inflation.error.generic": "计算失败，请检查输入。",
    "tool.inflation.out.amount": "金额",
    "tool.inflation.out.mode": "模式",
    "tool.inflation.out.rate": "通胀率",
    "tool.inflation.out.years": "年数",
    "tool.inflation.out.cumulative": "累计通胀",
    "tool.inflation.out.result": "结果",
    "tool.inflation.out.future": "未来价值",
    "tool.inflation.out.today": "折算为今日价值",
    "tool.inflation.out.breakdown": "年度明细",
    "tool.inflation.out.year": "Year",

    "tool.fourPercentRule.disclaimer": "仅供估算，不构成理财建议。",
    "tool.fourPercentRule.spending": "年度开销",
    "tool.fourPercentRule.spendingPlaceholder": "例如：60000",
    "tool.fourPercentRule.rate": "提取率 %",
    "tool.fourPercentRule.current": "当前储蓄（可选）",
    "tool.fourPercentRule.currentPlaceholder": "例如：250000",
    "tool.fourPercentRule.showTable": "显示常用提取率表",
    "tool.fourPercentRule.calculate": "计算",
    "tool.fourPercentRule.status.done": "计算完成",
    "tool.fourPercentRule.error.spending": "请输入合法年度开销金额",
    "tool.fourPercentRule.error.current": "请输入合法当前储蓄金额",
    "tool.fourPercentRule.error.rate": "请输入合法提取率",
    "tool.fourPercentRule.out.spending": "年度开销",
    "tool.fourPercentRule.out.monthly": "月开销",
    "tool.fourPercentRule.out.rate": "提取率",
    "tool.fourPercentRule.out.multiplier": "倍数",
    "tool.fourPercentRule.out.required": "所需储蓄",
    "tool.fourPercentRule.out.current": "当前储蓄",
    "tool.fourPercentRule.out.gap": "差额",
    "tool.fourPercentRule.out.gap.ok": "已达标",
    "tool.fourPercentRule.out.gap.more": "还需更多",
    "tool.fourPercentRule.out.table": "常用提取率",

    "tool.fire.disclaimer": "仅供估算，不构成理财建议。",
    "tool.fire.expenses": "年度支出",
    "tool.fire.expensesPlaceholder": "例如：60000",
    "tool.fire.portfolio": "当前投资组合",
    "tool.fire.portfolioPlaceholder": "例如：150000",
    "tool.fire.savings": "年度储蓄（投入）",
    "tool.fire.savingsPlaceholder": "例如：25000",
    "tool.fire.return": "年化收益率 %",
    "tool.fire.withdrawal": "提取率 %",
    "tool.fire.showTable": "显示年度预测",
    "tool.fire.calculate": "计算",
    "tool.fire.status.done": "计算完成",
    "tool.fire.year": "年",
    "tool.fire.years": "年",
    "tool.fire.error.expenses": "请输入合法的年度支出",
    "tool.fire.error.portfolio": "请输入合法的当前投资组合金额",
    "tool.fire.error.savings": "请输入合法的年度储蓄金额",
    "tool.fire.error.withdrawal": "提取率不合法",
    "tool.fire.error.unreachable": "在当前储蓄与收益率条件下无法达到目标",
    "tool.fire.error.timeout": "计算超时（年限过长），请调整参数",
    "tool.fire.out.expenses": "年度支出",
    "tool.fire.out.withdrawal": "提取率",
    "tool.fire.out.fireNumber": "FIRE 目标金额",
    "tool.fire.out.portfolio": "当前投资组合",
    "tool.fire.out.safeSpendNow": "按当前组合可安全支出",
    "tool.fire.out.gap": "差额",
    "tool.fire.out.savings": "年度储蓄",
    "tool.fire.out.return": "年化收益率",
    "tool.fire.out.savingsRate": "储蓄率",
    "tool.fire.out.timeToFire": "达到 FIRE 需要",
    "tool.fire.out.estimateYear": "预计达到年份",
    "tool.fire.out.table": "年度预测",
    "tool.fire.out.year": "年份",
    ...
    "tool.rentAfford.amount": "金额",
    "tool.rentAfford.amountPlaceholder": "例如：6000",
    "tool.rentAfford.mode": "模式",
    "tool.rentAfford.mode.incomeToRent": "收入 → 可承受租金",
    "tool.rentAfford.mode.rentToIncome": "租金 → 所需收入",
    "tool.rentAfford.percent": "租金占收入比例",
    "tool.rentAfford.presets": "常用：",
    "tool.rentAfford.calculate": "计算",
    "tool.rentAfford.status.done": "计算完成",
    "tool.rentAfford.error.amount": "请输入合法金额",
    "tool.rentAfford.error.percent": "请输入合法比例",
    "tool.rentAfford.out.mode": "模式",
    "tool.rentAfford.out.rule": "规则",
    "tool.rentAfford.out.rentAtMost": "租金最多",
    "tool.rentAfford.out.incomeAtLeast": "收入至少",
    "tool.rentAfford.out.rent": "租金",
    "tool.rentAfford.out.monthlyIncome": "月收入",
    "tool.rentAfford.out.maxRent": "最大租金（月）",
    "tool.rentAfford.out.maxAnnualRent": "最大租金（年）",
    "tool.rentAfford.out.requiredMonthlyIncome": "所需月收入",
    "tool.rentAfford.out.requiredAnnualIncome": "所需年收入",

    "tool.rentVsBuy.disclaimer": "仅供估算，不构成理财建议。",
    "tool.rentVsBuy.rent": "月租金",
    "tool.rentVsBuy.rentPlaceholder": "例如：2400",
    "tool.rentVsBuy.rentGrowth": "租金涨幅 % / 年",
    "tool.rentVsBuy.price": "房价",
    "tool.rentVsBuy.pricePlaceholder": "例如：450000",
    "tool.rentVsBuy.downMode": "首付",
    "tool.rentVsBuy.downMode.percent": "百分比",
    "tool.rentVsBuy.downMode.amount": "金额",
    "tool.rentVsBuy.down": "首付数值",
    "tool.rentVsBuy.downPlaceholder": "例如：20",
    "tool.rentVsBuy.apr": "APR %",
    "tool.rentVsBuy.termYears": "期限",
    "tool.rentVsBuy.years": "年",
    "tool.rentVsBuy.closingPct": "买入交易成本 %",
    "tool.rentVsBuy.sellingPct": "卖出交易成本 %",
    "tool.rentVsBuy.tax": "房产税 / 年",
    "tool.rentVsBuy.taxPlaceholder": "例如：6000",
    "tool.rentVsBuy.insurance": "保险 / 年",
    "tool.rentVsBuy.insurancePlaceholder": "例如：1200",
    "tool.rentVsBuy.hoa": "HOA / 月",
    "tool.rentVsBuy.hoaPlaceholder": "例如：0",
    "tool.rentVsBuy.maintenancePct": "维护费 % / 年",
    "tool.rentVsBuy.appreciation": "房价增值 % / 年",
    "tool.rentVsBuy.horizon": "对比年限（年）",
    "tool.rentVsBuy.showTable": "显示年度表格",
    "tool.rentVsBuy.calculate": "计算",
    "tool.rentVsBuy.status.done": "计算完成",
    "tool.rentVsBuy.year": "年",
    "tool.rentVsBuy.error.rent": "请输入合法的月租金",
    "tool.rentVsBuy.error.price": "请输入合法的房价",
    "tool.rentVsBuy.error.down": "请输入合法的首付金额/比例",
    "tool.rentVsBuy.error.generic": "计算失败，请检查输入",
    "tool.rentVsBuy.out.horizon": "对比年限",
    "tool.rentVsBuy.out.rent": "租金",
    "tool.rentVsBuy.out.rentTotal": "租房总支出",
    "tool.rentVsBuy.out.price": "房价",
    "tool.rentVsBuy.out.down": "首付",
    "tool.rentVsBuy.out.loan": "贷款金额",
    "tool.rentVsBuy.out.apr": "APR",
    "tool.rentVsBuy.out.payment": "月供",
    "tool.rentVsBuy.out.closing": "买入交易成本",
    "tool.rentVsBuy.out.selling": "卖出交易成本",
    "tool.rentVsBuy.out.appreciation": "房价增值率",
    "tool.rentVsBuy.out.maintenance": "维护费率",
    "tool.rentVsBuy.out.homeValue": "期末房价",
    "tool.rentVsBuy.out.balance": "期末剩余贷款",
    "tool.rentVsBuy.out.buyNet": "买房净成本",
    "tool.rentVsBuy.out.breakEven": "盈亏平衡点",
    "tool.rentVsBuy.out.none": "无",
    "tool.rentVsBuy.out.table": "年度对比",
    "tool.rentVsBuy.out.year": "年份",

    "tool.dti.disclaimer": "仅供估算，不构成理财建议。",
    "tool.dti.income": "月总收入（税前）",
    "tool.dti.incomePlaceholder": "例如：6500",
    "tool.dti.housing": "住房（房租/房贷）",
    "tool.dti.housingPlaceholder": "例如：1800",
    "tool.dti.car": "车贷",
    "tool.dti.carPlaceholder": "例如：350",
    "tool.dti.student": "学生贷款",
    "tool.dti.studentPlaceholder": "例如：0",
    "tool.dti.credit": "信用卡（最低还款）",
    "tool.dti.creditPlaceholder": "例如：120",
    "tool.dti.other": "其他负债",
    "tool.dti.otherPlaceholder": "例如：0",
    "tool.dti.calculate": "计算",
    "tool.dti.status.done": "计算完成",
    "tool.dti.error.income": "请输入合法月收入",
    "tool.dti.error.debt": "请输入 {field} 的合法金额",
    "tool.dti.category.unknown": "未知",
    "tool.dti.category.low": "低（< 20%）",
    "tool.dti.category.ok": "一般（< 36%）",
    "tool.dti.category.borderline": "偏高（36–43%）",
    "tool.dti.category.high": "高（43%+）",
    "tool.dti.out.income": "月收入",
    "tool.dti.out.totalDebt": "月负债合计",
    "tool.dti.out.dti": "DTI",
    "tool.dti.out.category": "分类",
    "tool.dti.out.breakdown": "明细",
    ...
    "tool.debtPayoffPlan.disclaimer": "仅供估算，不构成理财建议。",
    "tool.debtPayoffPlan.debts": "债务列表（每行一项）",
    "tool.debtPayoffPlan.debtsPlaceholder": "例如：\nVisa：3500 24.99 120\n车贷：9000 6.50 200",
    "tool.debtPayoffPlan.method": "策略",
    "tool.debtPayoffPlan.method.snowball": "雪球（先还余额最小）",
    "tool.debtPayoffPlan.method.avalanche": "雪崩（先还利率最高）",
    "tool.debtPayoffPlan.method.snowballShort": "雪球",
    "tool.debtPayoffPlan.method.avalancheShort": "雪崩",
    "tool.debtPayoffPlan.extra": "每月额外还款",
    "tool.debtPayoffPlan.extraPlaceholder": "例如：200",
    "tool.debtPayoffPlan.rollover": "将已还清的最低还款滚入预算",
    "tool.debtPayoffPlan.showSchedule": "显示前 12 个月",
    "tool.debtPayoffPlan.calculate": "计算",
    "tool.debtPayoffPlan.debt": "债务",
    "tool.debtPayoffPlan.yes": "是",
    "tool.debtPayoffPlan.no": "否",
    "tool.debtPayoffPlan.months": "个月",
    "tool.debtPayoffPlan.years": "年",
    "tool.debtPayoffPlan.status.done": "计算完成",
    "tool.debtPayoffPlan.error.extra": "请输入合法的额外还款金额",
    "tool.debtPayoffPlan.error.noDebts": "请至少输入一条债务记录（余额 APR 最低还款）",
    "tool.debtPayoffPlan.error.budget": "每月预算必须大于 0",
    "tool.debtPayoffPlan.error.noProgress": "最低还款不足以覆盖利息，余额会增长（无法还清）",
    "tool.debtPayoffPlan.error.timeout": "计算超时（可能需要太久），请调整输入",
    "tool.debtPayoffPlan.out.debts": "债务数",
    "tool.debtPayoffPlan.out.method": "策略",
    "tool.debtPayoffPlan.out.extra": "额外还款",
    "tool.debtPayoffPlan.out.rollover": "滚入最低还款",
    "tool.debtPayoffPlan.out.monthlyBudget": "每月总预算",
    "tool.debtPayoffPlan.out.payoffTime": "还清时间",
    "tool.debtPayoffPlan.out.payoffDate": "预计还清日期",
    "tool.debtPayoffPlan.out.totalPaid": "总还款",
    "tool.debtPayoffPlan.out.totalInterest": "总利息",
    "tool.debtPayoffPlan.out.debtsLeft": "剩余债务",
    "tool.debtPayoffPlan.out.ignoredLines": "忽略行数",
    "tool.debtPayoffPlan.out.payoffOrder": "还清顺序",
    "tool.debtPayoffPlan.out.firstMonths": "前 12 个月",
    "tool.debtPayoffPlan.out.balance": "余额",
    "tool.debtPayoffPlan.out.payment": "还款",
    "tool.debtPayoffPlan.out.interest": "利息",
    ...
    "tool.investmentFees.disclaimer": "仅供估算，不构成理财建议。",
    "tool.investmentFees.principal": "初始金额",
    "tool.investmentFees.principalPlaceholder": "例如：10000",
    "tool.investmentFees.contribution": "每月投入",
    "tool.investmentFees.contributionPlaceholder": "例如：300",
    "tool.investmentFees.return": "年化收益率 %（未扣费）",
    "tool.investmentFees.fee": "年费率 %（费用率）",
    "tool.investmentFees.years": "年数",
    "tool.investmentFees.timing": "投入时点",
    "tool.investmentFees.timing.end": "月末",
    "tool.investmentFees.timing.start": "月初",
    "tool.investmentFees.showBreakdown": "显示年度明细",
    "tool.investmentFees.calculate": "计算",
    "tool.investmentFees.status.done": "计算完成",
    "tool.investmentFees.error.principal": "请输入合法的初始金额",
    "tool.investmentFees.error.contribution": "请输入合法的每月投入金额",
    "tool.investmentFees.error.years": "请输入合法的年数",
    "tool.investmentFees.out.principal": "初始金额",
    "tool.investmentFees.out.contribution": "每月投入",
    "tool.investmentFees.out.return": "年化收益率",
    "tool.investmentFees.out.fee": "年费率",
    "tool.investmentFees.out.years": "年数",
    "tool.investmentFees.out.timing": "投入时点",
    "tool.investmentFees.out.totalContrib": "累计投入",
    "tool.investmentFees.out.finalNoFee": "期末金额（不扣费）",
    "tool.investmentFees.out.finalWithFee": "期末金额（扣费后）",
    "tool.investmentFees.out.diff": "差额",
    "tool.investmentFees.out.feesPaid": "累计费用",
    "tool.investmentFees.out.breakdown": "年度明细",
    "tool.investmentFees.out.year": "年份",
    "tool.investmentFees.out.noFee": "不扣费",
    "tool.investmentFees.out.withFee": "扣费后",

    "tool.savingsGoal.disclaimer": "仅供估算，不构成理财建议。",
    "tool.savingsGoal.mode": "模式",
    "tool.savingsGoal.mode.time": "达到目标所需时间",
    "tool.savingsGoal.mode.monthly": "反推每月需要存多少",
    "tool.savingsGoal.start": "初始金额",
    "tool.savingsGoal.startPlaceholder": "例如：1000",
    "tool.savingsGoal.goal": "目标金额",
    "tool.savingsGoal.goalPlaceholder": "例如：20000",
    "tool.savingsGoal.monthly": "每月存入",
    "tool.savingsGoal.monthlyPlaceholder": "例如：300",
    "tool.savingsGoal.targetTime": "目标周期",
    "tool.savingsGoal.years": "年",
    "tool.savingsGoal.months": "个月",
    "tool.savingsGoal.rate": "利率（APY %）（可选）",
    "tool.savingsGoal.timing": "存入时间",
    "tool.savingsGoal.timing.end": "每月月底",
    "tool.savingsGoal.timing.start": "每月月初",
    "tool.savingsGoal.showSchedule": "显示前 12 个月",
    "tool.savingsGoal.calculate": "计算",
    "tool.savingsGoal.status.done": "计算完成",
    "tool.savingsGoal.error.goal": "请输入合法的目标金额",
    "tool.savingsGoal.error.start": "请输入合法的初始金额",
    "tool.savingsGoal.error.monthly": "请输入合法的每月存入金额",
    "tool.savingsGoal.error.targetTime": "请输入合法的目标周期",
    "tool.savingsGoal.error.unreachable": "在当前输入下无法达到目标。",
    "tool.savingsGoal.error.generic": "计算失败，请检查输入。",
    "tool.savingsGoal.out.mode": "模式",
    "tool.savingsGoal.out.start": "初始金额",
    "tool.savingsGoal.out.goal": "目标金额",
    "tool.savingsGoal.out.apy": "APY",
    "tool.savingsGoal.out.timing": "存入时间",
    "tool.savingsGoal.out.targetTime": "目标周期",
    "tool.savingsGoal.out.requiredMonthly": "需要每月存入",
    "tool.savingsGoal.out.monthly": "每月存入",
    "tool.savingsGoal.out.timeToGoal": "达到目标所需",
    "tool.savingsGoal.out.goalDate": "预计达到日期",
    "tool.savingsGoal.out.endBalance": "期末余额",
    "tool.savingsGoal.out.firstMonths": "前 12 个月",
    "tool.savingsGoal.out.deposit": "存入",
    "tool.savingsGoal.out.interest": "利息",
    "tool.savingsGoal.out.balance": "余额",

    "tool.retirement.disclaimer": "仅供估算，不构成理财建议。",
    "tool.retirement.currentAge": "当前年龄",
    "tool.retirement.retireAge": "退休年龄",
    "tool.retirement.balance": "当前储蓄",
    "tool.retirement.balancePlaceholder": "例如：20000",
    "tool.retirement.salary": "年薪",
    "tool.retirement.salaryPlaceholder": "例如：80000",
    "tool.retirement.employeePct": "个人缴纳 %",
    "tool.retirement.matchRate": "雇主匹配 %",
    "tool.retirement.matchCap": "最多匹配到工资的 %",
    "tool.retirement.return": "年化收益 %",
    "tool.retirement.growth": "年薪增长 %",
    "tool.retirement.showTable": "显示年度明细",
    "tool.retirement.calculate": "计算",
    "tool.retirement.status.done": "计算完成",
    "tool.retirement.error.ages": "退休年龄必须大于当前年龄",
    "tool.retirement.error.balance": "请输入合法的当前储蓄金额",
    "tool.retirement.error.salary": "请输入合法的年薪",
    "tool.retirement.years": "年",
    "tool.retirement.year": "年",
    "tool.retirement.out.currentAge": "当前年龄",
    "tool.retirement.out.retireAge": "退休年龄",
    "tool.retirement.out.horizon": "时间跨度",
    "tool.retirement.out.startBalance": "起始储蓄",
    "tool.retirement.out.salary": "年薪",
    "tool.retirement.out.employeePct": "个人缴纳",
    "tool.retirement.out.employerMatch": "雇主匹配",
    "tool.retirement.out.matchUpTo": "最多到",
    "tool.retirement.out.contribNow": "当前年薪下的预计年度缴纳",
    "tool.retirement.out.assumedReturn": "假设年化收益",
    "tool.retirement.out.salaryGrowth": "年薪增长",
    "tool.retirement.out.finalBalance": "退休时预计余额",
    "tool.retirement.out.totalEmployee": "个人累计缴纳",
    "tool.retirement.out.totalEmployer": "雇主累计匹配",
    "tool.retirement.out.totalContrib": "累计缴纳合计",
    "tool.retirement.out.growth": "预计投资增长",
    "tool.retirement.out.yearlyBreakdown": "年度明细",
    "tool.retirement.out.age": "年龄",
    "tool.retirement.out.balance": "余额",

    "tool.cagr.start": "起始值",
    "tool.cagr.startPlaceholder": "例如：10000",
    "tool.cagr.end": "结束值",
    "tool.cagr.endPlaceholder": "例如：16000",
    "tool.cagr.years": "年数",
    "tool.cagr.presets": "常用：",
    "tool.cagr.calculate": "计算",
    "tool.cagr.status.done": "计算完成",
    "tool.cagr.error.start": "请输入合法起始值",
    "tool.cagr.error.end": "请输入合法结束值",
    "tool.cagr.error.years": "请输入合法年数",
    "tool.cagr.error.generic": "计算失败，请检查输入",
    "tool.cagr.out.start": "起始值",
    "tool.cagr.out.end": "结束值",
    "tool.cagr.out.years": "年数",
    "tool.cagr.out.multiple": "倍数",
    "tool.cagr.out.totalReturn": "总回报",
    "tool.cagr.out.cagr": "CAGR",
    "tool.cagr.out.monthly": "月化等效",
